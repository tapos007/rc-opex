...
<!--                    <li><a class="" href="<?php //echo site_url('con_set_holiday/view'); ?>">Holidays</a></li>
                    <li><a class="" href="<?php //echo site_url('con_pro_daily_leave_report/create'); ?>">Leave Allocation</a></li>-->
                    <li><a class="" href="<?php echo site_url('con_set_leave_catagory/view'); ?>">Leave Category</a></li>
                    <li><a class="" href="<?php echo site_url('con_proc_leave_type_allocation'); ?>">Leave Allocation</a></li>
