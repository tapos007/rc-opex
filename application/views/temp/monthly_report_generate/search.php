<div class='row' style="margin-top: 100px;">
    ...
    <div class='col-lg-8'>
        ...
        echo form_open('con_proc_monthly_report_generate/view_by_id', $attr);
        ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <a href="<?php echo site_url('con_proc_monthly_report_generate/generate_monthly_report'); ?>"  class="btn btn-success" id="update"  >Monthly Report Generate</a>
            </div>
            <div class="col-sm-9">
                <a href="<?php echo site_url('con_proc_monthly_report_generate/view_monthly_report'); ?>"  class="btn btn-success" id="update"  >Monthly Report View</a>
            </div>
