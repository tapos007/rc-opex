...
class Mod_pro_employee_monthly_report extends CI_Model {
    ...
    public function view_by_CardNo($CardNo,$Month) {
       ...
       $Q =  "select inc.CardNo, inc.DateTime, emp.Name, emp.Line, emp.Department from tbl_access_log as inc left join tbl_employee_profile as emp on inc.CardNo = emp.CardNo where inc.CardNo = '".$CardNo."' and inc.datetime between '".$LikeDate."' and '".$LikeDateEnd."' order by DateTime";
