...
class Mod_set_additional_reward_worker extends CI_Model {
    ...
    public function insert() {
        ...
        $this->db->insert('tbl_additional_reward_worker', $data);
    }
    ...
    public function view() {
        $this->db->select('*');
        $this->db->from('tbl_additional_reward_worker');
        $query = $this->db->get();
        return $query->result();
    }
    ...
    public function delete_by_id($id) {
        $this->db->where('ID', $id);
        $this->db->delete('tbl_additional_reward_worker');
    }
    ...
    public function update() {
        ...
        $this->db->where('ID', $this->ID);
        if ($this->db->update('tbl_additional_reward_worker', $data)) {
            return TRUE;
        }
        return false;
    }
