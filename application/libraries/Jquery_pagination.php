...
class Jquery_pagination{
	...
	var $first_link   		= 'সর্ব প্রথম';
	var $next_link			= 'পরবর্তী';
	var $prev_link			= 'পূর্ববর্তী';
	var $last_link			= 'সর্ব শেষ';
	var $uri_segment		= 3;
   ...
   var $show_count      = true;
	...
	function getAJAXlink( $count, $text) {
		...
		return "<a class='kkk' href=\"#\". $this->js_rebind
		         " . $this->anchor_class . 
					">"
				. $text .'</a>';
	}
